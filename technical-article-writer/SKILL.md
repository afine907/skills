...
本技能帮助 Claude 编写专业、可直接发布的技术文章。通过检索相关资料，生成包含以下要素的结构化文章：
- 清晰的标题和目录结构
- 教程式实践步骤
- 语法高亮且带行号的代码示例
- 完整的参考资料来源
...
- 搜索工具不可用：基于已有知识编写，在文中标注"待补充参考资料"
- 主题过于宽泛：建议用户缩小范围，先写一个子主题
- 代码示例无法运行：添加注释说明运行环境要求，提供完整依赖
- 文章过长（>5000字）：拆分为系列文章，每篇聚焦一个子主题
